...
int dosInitArt50()
{
    ...
    if ( g_sdkVer < 28 )
    {
        if ( g_sdkVer < 26 )
        {
            ...
            {
                v4 = j_get_libart_funaddr((int)"_ZN3art11ClassLinker10LoadMethodEPNS_6ThreadERKNS_7DexFileERKNS_21ClassDataItemIt"
                                               "eratorENS_6HandleINS_6mirror5ClassEEEPNS_9ArtMethodE");
                _android_log_print(6, (int)"2g.out", "the addr = %p", v4);
                j_hookFunAddr(v4, artMClassLinkerLoadMethodStub, &artMClassLinkerLoadMethodOri);
                v5 = j_get_libart_funaddr((int)"_ZNK3art7OatFile9OatMethod10LinkMethodEPNS_9ArtMethodE");
                j_hookFunAddr(v5, artMOatFileOatMethodLinkMethodStub, &artMOatFileOatMethodLinkMethodOri);
            }
        }
        else
        {
            v2 = j_get_libart_funaddr((int)"_ZN3art11ClassLinker10LoadMethodERKNS_7DexFileERKNS_21ClassDataItemIteratorENS_6Han"
                                           "dleINS_6mirror5ClassEEEPNS_9ArtMethodE");
            _android_log_print(6, (int)"2g.out", "the addr = %p", v2);
            j_hookFunAddr(v2, artOClassLinkerLoadMethodStub, &artOClassLinkerLoadMethodOri);
            v3 = j_get_libart_funaddr((int)"_ZNK3art7OatFile9OatMethod10LinkMethodEPNS_9ArtMethodE");
            j_hookFunAddr(v3, artMOatFileOatMethodLinkMethodStub, &artMOatFileOatMethodLinkMethodOri);
        }
    }
    else
    {
        v0 = j_get_libart_funaddr((int)"_ZN3art11ClassLinker10LoadMethodERKNS_7DexFileERKNS_21ClassDataItemIteratorENS_6Handl"
                                       "eINS_6mirror5ClassEEEPNS_9ArtMethodE");
        _android_log_print(6, (int)"2g.out", "the addr = %p", v0);// 这里是Android 9
        j_hookFunAddr(v0, artPClassLinkerLoadMethodStub, &artPClassLinkerLoadMethodOri);
        v1 = j_get_libart_funaddr((int)"_ZNK3art7OatFile9OatMethod10LinkMethodEPNS_9ArtMethodE");
        j_hookFunAddr(v1, artMOatFileOatMethodLinkMethodStub, &artMOatFileOatMethodLinkMethodOri);
    }
    return _stack_chk_guard;
}